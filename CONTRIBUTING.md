# Contributing to wasm-languages
...
``` shell
git remote add upstream https://github.com/vmware-wasmstack/wasm-languages.git
...
When your branch gets out of sync with the vmware-wasmstack/main branch, use the following to update:
